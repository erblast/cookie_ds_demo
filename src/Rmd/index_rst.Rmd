...
# Documentation
- [snakemake report](https://erblast.github.io/cookie_ds_demo//snakemake_report/index.html)

- [cookiedsdemopkgr documentation](https://erblast.github.io/cookie_ds_demo//cookiedsdemopkgr/index.html)

- [README](https://erblast.github.io/cookie_ds_demo//README.html)
...
```{r echo = FALSE }
mdown_list = paste0("- [", files, "](https://erblast.github.io/cookie_ds_demo//html/", files, ')' ) %>%
  paste( collapse = '\n')
```
